...
public class SifreDegistirKullaniciEkrani extends javax.swing.JFrame {

    /**
     * Creates new form SifreDegistirKullaniciEkrani
     */
    public SifreDegistirKullaniciEkrani() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Şifre Değiştir - Kullanıcı");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SifreDegistirKullaniciEkrani.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SifreDegistirKullaniciEkrani().setVisible(true);
            }
        });
    }
    ...
    private void sifreGuncelle(){
        ...
        String SQLguncelle ="UPDATE kullanici SET sifre ='"+ sifre +"'" +" where kullanici_adi='" + kullaniciAdi +"' and kullanici_id= 1 and TC = '" + tc +"'";
